...
const Search: React.FC<SearchProps> = ({ text, placeholder, onChange }) => {

    const handleInputChange: React.ChangeEventHandler<HTMLInputElement> = (event) => {
        onChange(event.target.value);
    };
    return (
        <div className='flex bg-white w-[450px] p-[15px] rounded-[15px] gap-[10px] border-solid border-[#CBD5E4] border-[2px]'>
